...
from main_simpleshot import single_run_main
...
if __name__ == '__main__':
    ...
    with open("SimpleShot_params.yaml") as stream:
    ...
    for name in params['models']:
        ...
        if params['data']['variable']:
            batch_funcs = [prep_batch_conventional, prep_var_eval]
        elif params['data']['variable'] == False:
            batch_funcs = [prep_batch_conventional, prep_batch_fixed]
        else:
        ...
        for i in model_loop:
            ...
            post, loss, post_std = single_run_main(params=params, 
                                                model_name=name,
                                                device=device,
                                                prep_batch_fns=batch_funcs,
                                                seed=seed)
