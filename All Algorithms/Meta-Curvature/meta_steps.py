"""
Script contains the main meta step functions needed for both fixed and variable 
    length datasets. In theory it is possible to simply generalise these functions 
...
def meta_step_fixed(maml_model, optimiser, loss_fn, x, y, train, adapt_steps, 
    ...
    return back_loss.item(), avg_pre, avg_post, all_post
