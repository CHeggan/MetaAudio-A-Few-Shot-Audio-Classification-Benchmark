...
from meta_fit import mb_fit
from mb_episode import meta_episode_fixed, meta_episode_var
from prep_batch_functions import prep_batch_fixed, prep_var_eval
...
# MAIN
###############################################################################
def meta_baseline_main(params, model, device):
    ...
    meta_opt = optim.Adam(model.parameters(), lr=params['hyper']['meta_lr'])
    ...
    if params['data']['variable']:
        batch_fns = [prep_batch_fixed, prep_var_eval]
    elif params['data']['variable'] == False:
        batch_fns = [prep_batch_fixed, prep_batch_fixed]
    else:
    ...
    post, loss, post_std = mb_fit(
                    ...
                    fit_functions=[meta_episode_fixed, eval_step],
                    params=params,
